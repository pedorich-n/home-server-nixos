    ...
    containers = {
      authentik-postgresql = {
        ...
        containerConfig = {
          ...
          environmentFiles = [ config.sops.secrets."authentik/postgresql".path ];
          volumes = [
      ...
      authentik-worker = {
        ...
        containerConfig = {
          ...
          notify = "healthy";
          environments = defaultEnvs;
          environmentFiles = [ config.sops.secrets."authentik/main".path ];
          volumes = [
      ...
      authentik-ldap = {
        ...
        containerConfig = {
          ...
          environmentFiles = [ config.sops.secrets."authentik/ldap_outpost".path ];
          labels = [
            "traefik.enable=true"
