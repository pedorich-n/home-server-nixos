        ...
        lib.types.submodule (
          { name, ... }:
          {
            config = {
              ...
              environmentFile = lib.mkDefault config.sops.templates."restic/${name}/environment".path;
              repositoryFile = lib.mkDefault config.sops.templates."restic/${name}/repository".path;
