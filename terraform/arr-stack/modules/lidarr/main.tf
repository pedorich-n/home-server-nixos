...
resource "lidarr_naming" "naming" {
  ...
  standard_track_format      = "{[Release Year] }{Album CleanTitle}/{Track ArtistCleanName} - {Album CleanTitle} - {track:00} - {Track CleanTitle}"
  multi_disc_track_format    = "{[Release Year] }{Album CleanTitle}/{Medium Format}/{medium:00}/{Track ArtistCleanName} - {Album CleanTitle} - {track:00} - {Track CleanTitle}"
